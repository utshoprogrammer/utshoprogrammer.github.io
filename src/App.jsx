...
export default function App() {
  ...
  const onSubmit = async (data) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      setStatus({ text: "Email service is not configured yet.", type: "error" });
      return;
    }
          ...
          <div className="container">
            ...
            <div className="contact-grid">
              ...
              >
                ...
                <div className="form-actions" style={{ position: "relative", display: "flex", alignItems: "center", gap: "1rem", marginTop: "1rem" }}>
